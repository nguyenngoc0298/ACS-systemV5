  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route
          exact
          path={ROUTE.LICH_LAM_VIEC_ADD}
          component={LichLamViecAdd}
        />
        <Route
          exact
          path={ROUTE.LICH_LAM_VIEC_EDIT}
          component={LichLamViecEdit}
        />
        <Route
          exact
          path={ROUTE.LICH_LAM_VIEC_DETAIL}
          component={LichLamViecChiTiet}
        />
        <Route exact path={ROUTE.LOAI_DICH_VU} component={LoaiDichVu} />
        <Route exact path={ROUTE.LOAI_DICH_VU_ADD} component={LoaiDichVuAdd} />
        <Route
          exact
          path={ROUTE.LOAI_DICH_VU_DETAIL}
          component={LoaiDichVuChiTiet}
        />
        ...
        <Route
          exact
          path={ROUTE.KHUYEN_MAI_DETAIL}
          component={KhuyenMaiChiTiet}
        />
        ...
        <Route
          exact
          path={ROUTE.CHI_NHANH_DETAIL}
          component={ChiNhanhChiTiet}
        />
